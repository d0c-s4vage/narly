...
Currently, only listing info about loaded modules is implemented. It will probably be worth
it to check back every now and then for a new release, as a lot is currently in the works. You
may also ping me directly to see if anything new is on its way. Also, if you find a bug with
...
After you do that, you can .load narly to load the extension into windbg:
